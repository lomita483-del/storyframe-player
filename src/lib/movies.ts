...
const MOVIE_FIELDS =
  'id,title,slug,description,poster_url,backdrop_url,video_url,direct_stream_url,video_type,subtitle_url,trailer_url,embed_url,embed_provider,provider,provider_asset_id,where_to_watch,genre,release_year,release_date,content_kind,runtime,rating,quality,cast,director,is_published,is_featured,is_trending,media_type,tmdb_id,popularity,first_air_date,created_at,updated_at';
